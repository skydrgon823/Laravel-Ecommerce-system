...
@else
    <div class="form-group mb-3 @if ($errors->has('slug')) has-error @endif">
        {!! Form::permalink('slug', $object->slug, $object->slug_id, $prefix, SlugHelper::canPreview(get_class($object)) && $object->status != \Botble\Base\Enums\BaseStatusEnum::PUBLISHED, [], true, get_class($object)) !!}
        {!! Form::error('slug', $errors) !!}
    </div>
@endif
